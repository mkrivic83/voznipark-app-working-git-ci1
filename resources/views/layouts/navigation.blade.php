      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:ml-6 sm:block">
          <div class="flex space-x-4">
            ...
            <a href="{{route('vozila.index')}}"  class="rounded-md px-3 py-2 text-sm font-medium
             {{ request()->routeIs('vozila.index') ? 'text-red-700 bg-white/10' : 'text-gray-300' }}
            p-2 hover:bg-white/5 hover:text-white">Vozila</a>
            <a href="/namjene" class="rounded-md px-3 py-2 text-sm font-medium
             {{ request()->routeIs('namjene.index') ? 'text-red-700 bg-white/10' : 'text-gray-300' }}
            hover:bg-white/5 hover:text-white">Namjene</a>
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Free link</a>
          </div>
        </div>
      </div>
