...
<div class="max-w-xl mx-auto py-10">
    ...
    <div class="bg-white shadow rounded p-6">
        <form method="POST" action="{{ route('vozila.update', $vozilo) }}">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="text" name="registracija"
                       class="mt-1 w-full border rounded px-3 py-2"
                       value="{{ old('registracija', $vozilo->registracija) }}">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="istek_registracije"
                       class="mt-1 w-full border rounded px-3 py-2"
                       value="{{ old('istek_registracije', $vozilo->istek_registracije->format('Y-m-d')) }}">
            ...
            <div class="mb-6">
                ...
                <select name="namjenaid"
                    ...
                    @foreach($namjene as $n)
                        <option value="{{ $n->id }}"
                            @selected(old('namjenaid', $vozilo->namjenaid) == $n->id)>
                            {{ $n->naziv }}
                        </option>
                    @endforeach
                </select>
